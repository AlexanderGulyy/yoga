$(function () {
  ...
  $('.reviews-slider').slick({
    ...
    slidesToScroll: 1,
    dots: true,
    prevArrow: '<button type="button" class="slick-btn slick-prev"><span class="icon-angle-left"></span></button>',
    nextArrow: '<button type="button" class="slick-btn slick-next"><span class="icon-angle-right"></span></button>',
    responsive: [
      {
        breakpoint: 501,
        settings: {
  ...
  $('.popup-btn').click(function () {
    $('.popup,.popup-request__overlay').fadeIn(400);
  });
  $('.closer,.popup-request__overlay').click(function () {
    $('.popup,.popup-request__overlay').fadeOut(400);
  });
